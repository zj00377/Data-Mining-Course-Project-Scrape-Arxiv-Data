...
scraper = arxivscraper.Scraper(category='math',date_from='2003-09-01',date_until='2004-08-31',t=30,filters={'categories':['math.DG']})
#scraper = arxivscraper.Scraper(category='math',date_from='2003-09-01',date_until='2004-08-31',t=30)
...
df.to_csv('scrape14.txt', header=None, index=None, sep='$', mode='a')

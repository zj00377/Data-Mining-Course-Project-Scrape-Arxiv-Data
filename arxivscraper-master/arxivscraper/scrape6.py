...
scraper = arxivscraper.Scraper(category='math',date_from='2011-09-01',date_until='2012-08-31',t=30,filters={'categories':['math.DG']})
#scraper = arxivscraper.Scraper(category='math',date_from='2011-09-01',date_until='2012-08-31',t=30)
...
df.to_csv('scrape6.txt', header=None, index=None, sep='$', mode='a')

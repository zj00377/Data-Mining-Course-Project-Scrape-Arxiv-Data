...
scraper = arxivscraper.Scraper(category='math',date_from='2007-09-01',date_until='2008-08-31',t=30,filters={'categories':['math.DG']})
#scraper = arxivscraper.Scraper(category='math',date_from='2007-09-01',date_until='2008-08-31',t=30)
...
df.to_csv('scrape10.txt', header=None, index=None, sep='$', mode='a')
